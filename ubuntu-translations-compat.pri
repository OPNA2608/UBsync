isEmpty(INSTALL_DATA):include(common-install.pri)
# compatibility with the Clickable Ubuntu SDK image, code imported from
# https://gitlab.com/clickable/clickable-docker-images/-/blob/a3ae87bc690014e68ccf19c3e2ee10d37458c6c4/ubuntu-sdk/20.04-cross-build/ubuntu-click-tools.prf
!click {
        ...
        !isEmpty(UBUNTU_PO_FILES){
            ...
            for(filelist, UBUNTU_PO_FILES) {
                ...
                for(file,resolved_filelist) {
                    ...
                    $${target_name}_inst.path = $${INSTALL_DATA}/locale/$${lang}/LC_MESSAGES
